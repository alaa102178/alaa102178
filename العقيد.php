/*
تم نشر الملف شبية بسورس العقيد من قبل المطور عقيد 
...
ob_start();
error_reporting(0);
define('API_KEY','6879368585:AAFi1W3nZ85YD9Y-uvph5GZYsTaIWgakzFg');
...
$Dev = array("6716174264","6716174264","6716174264"); //ID ADMIN NUMBER 1 HE CHAT
@$usernamebot = "aladdin111bot"; //UserName Bot
@$channel = "A_LAA22"; // UserName Channel don't @
@$token = API_KEY;
...
'inline_keyboard'=>[
[
['text'=>"تابع جديدنا",'url'=>"https://t.me/A_LAA22"],['text'=>"$dataadd",'callback_data'=>"text"]
],
]
])
]); 
...
'inline_keyboard'=>[
 	[
['text'=>"📢 تابع جديدنا 📢",'url'=>"https://t.me/A_LAA22"]
  ],
   ]
   ])
 ]); 
